    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 px-6 md:px-12 bg-gradient-to-br from-background via-background to-secondary/10">
        <div className="container max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-xl mx-auto">Language barriers shouldn't limit communication. My AI-powered translator breaks down these barriers in real-time conversations.</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6 lg:col-span-1">
                  ...
                  <p className="text-card-foreground/90">
                    An advanced speech-to-speech translation application that leverages
                    cutting-edge AI to provide real-time translations across multiple languages.
                    Perfect for travelers asking locals for directions, finding restaurants, or
                    having meaningful conversations with people who speak different languages.
                  </p>
